        ...
        <div>
          <div className="container-fluid bg-announce d-flex align-items-center announce-height">
            <div className="container col-xxl-4 col-xl-5 col-lg-6 col-md-8 d-flex justify-content-center align-items-center announce-search">
              <p className="title mb-5 mt-5">문의사항</p>
                ...
                <div className="card-body p-2">
                  <div className="input-group input-group-lg">
                    <input
                      type="text"
                      id="searchWord"
                      className="form-control form-control-lg rounde bg-transparent"
                  ...
                  <div className="row">
                    ...
                    <div className="col-4">
                      <button className="btn-rounded text-white text-center send-button">
                        <div className="p-relative" style={{ top: "-2px" }}>
                          Send
                        </div>
                      </button>
                    </div>
              ...
              <div className="문의사항 col-lg-6">
                ...
                >
                  <div className="d-flex">
                    ...
                    <div>1F, 63-6, Donggyo-ro, Mapo-gu, Seoul</div>
                  </div>
                </div>
